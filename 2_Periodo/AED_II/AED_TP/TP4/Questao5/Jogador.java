...
public class Jogador {
    ...
    public static void main(String[] args) {
        ...
        arvoreJogadores.treeSort(arvoreJogadores.raiz);
        escreverLog("729577_treesort.txt", arvoreJogadores.numComparacoes);
     ...
     static void escreverLog(String nomeArquivo, int numComparacoes) {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(nomeArquivo))) {
            bw.write("Número de comparações: " + numComparacoes);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
